...
public class LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlblError.setForeground(new java.awt.Color(255, 51, 0));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jtxtCodigo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(4, 4, 4)
                .addComponent(jsepCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(23, 23, 23)
    ...
    private void enFoco(JLabel lbl, JTextField txt, JSeparator sep, String placeholder, boolean enFoco) {
        jlblError.setVisible(false);
        if (enFoco) {
            sep.setForeground(new java.awt.Color(0, 102, 255));
            lbl.setForeground(new java.awt.Color(0, 102, 255));
    ...
    private void mandarDatos() {
        ...
        if (usuario.getNombre().equals("Código universitario:") || usuario.getNombre().isEmpty()) {
            ...
            try {
                ...
                mostrarError("No se ha podido iniciar la sesión.");
            }
            System.out.println("user: " + usuario.getNombre() + " pass: " + usuario.getPass());
        }
    }
